<!--
INHERITED SPEC — verbatim copy, not maintained here.

Source:   onetimesecret/onetimesecret docs/specs/rodauth-admin/10-aggregate-visibility.md
Commit:   7a3df3ee0d8943ecc6bf61985a3a4ba44f4188cc (2026-08-03)
Copied:   2026-09-04

Read this through docs/CHARTER.md. The charter reverses the "no second admin
app" non-goal and relocates the work into this repository; the capability
table, Phase-1 queries, and 200k-row guardrails carry over, while every
colonel-console location (apps/api/colonel, src/apps/admin, ColonelAuditEvent,
role=colonel + verify_one_of_roles!) is superseded. See CHARTER.md §5.
-->
